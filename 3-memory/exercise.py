...
WINDOW_SIZE = 8  # stores 8 messages (4 turns)

def getHistory(session_id: str, store: dict) -> ChatMessageHistory:
...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are a real estate assistant of JR Imóveis from Catanduvas, SC, Brazil."
    "Client: {client_name}"
...
chain_window = RunnableWithMessageHistory(
    chain,
    lambda session_id: getHistory(session_id, store),
